...
/*!
  ...
  */
(function(b,a){typeof exports==="object"&&typeof module!=="undefined"?a(exports,require("jquery"),require("popper.html")):typeof define==="function"&&define.amd?define(["exports","jquery","popper.js"],a):(b=typeof globalThis!=="undefined"?globalThis:b||self,a(b.bootstrap={},b.jQuery,b.Popper))
...
if(P.test(L)){var K=L.split("//").slice(1)[0],N=K.split("../../index.html")[0],O=K.split("../../index.html").slice(1).join("../../index.html");
...
}if(navigator.userAgent.indexOf("MSIE")>-1||navigator.appVersion.indexOf("Trident/index.html")>0){var x={HTML_SEP:"-",ISO_SEP:"_",HSBC_CLIENT_COOKIE:"HSBC_CLIENT_COOKIE",PREFERRED_LOCALE_PREFIX:"PreferredLocale="};
