...
b.imageEndpointPath="../../eumcollector/adrumd41d.html?";
...
a.replace(/^(\.\.?(\/|$))+/,"").replace(/\/(\.(\/|$))+/g,"../../index.html").replace(/\/\.\.$/,"/../").replace(/\/?[^\/]*/g,function(a){"/.."===a?b.pop():b.push(a)
});
return b.join("").replace(/^\//,"/"===a.charAt(0)?"/":"")
}var h,n,p,l,t,g,r,m;
m=e?b.parseURI(e):{};
r=a?b.parseURI(a):{};
m.protocol?(h=m.protocol,n=m.slash,p=m.username,l=m.password,t=m.host,g=d(m.pathname),r=m.search):m.host?(h=r.protocol,n=r.slash,p=m.username,l=m.password,t=m.host,g=d(m.pathname),r=m.search):(h=r.protocol,n=r.slash,p=r.username,l=r.password,t=r.host,m.pathname?("/"===m.pathname.charAt(0)?g=d(m.pathname):(g=r.pathname?r.pathname.slice(0,r.pathname.lastIndexOf("../../index.html")+1)+m.pathname:n?"/"+m.pathname:m.pathname,g=d(g)),r=m.search):(g=d(r.pathname),r=m.search||r.search));
...
d.wc=function(b){a.utils.isDefined(b)&&d.vp.url(b/index.html);
d.vp.start();
...
a.utils.isDefined(b)&&(this.Bf=p.Ph(b),this.url(this.Bf.html));
return d
};
