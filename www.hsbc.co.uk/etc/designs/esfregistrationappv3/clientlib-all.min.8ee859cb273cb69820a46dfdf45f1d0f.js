window.WEBAUTH_REG_CONFIG=JSON.parse(document.getElementsByTagName("digital-security-platform-web")[0].getAttribute("dspconf"));
ADRUM_APP_KEY=window.WEBAUTH_REG_CONFIG.WEBAUTH_REGISTRATION_CONFIG.ADRUM_APP_KEY;
var entityCaptchaConfig=null;
if(window.WEBAUTH_REG_CONFIG){entityCaptchaConfig=window.WEBAUTH_REG_CONFIG.WEBAUTH_REGISTRATION_CONFIG.RE_CAPTCHA_CONFIG
}else{entityCaptchaConfig=JSON.parse(document.getElementsByTagName("digital-security-platform-web")[0].getAttribute("dspconf")).WEBAUTH_REGISTRATION_CONFIG.RE_CAPTCHA_CONFIG
}if(entityCaptchaConfig.enableCaptchaAPI){var entitySiteKey=entityCaptchaConfig.captchaSiteKey.trim();
var JSLink="../../../www.google.com/recaptcha/api11df.js?onload=ReCaptchaCallbackV3&amp;render="+entitySiteKey;
var JSElement=document.createElement("script");
JSElement.src=JSLink;
document.getElementsByTagName("head")[0].appendChild(JSElement);
setTimeout(function(){if(typeof grecaptcha=="undefined"){var a="../../../www.recaptcha.net/recaptcha/api3398.js?render="+entitySiteKey;
var b=document.createElement("script");
b.src=a;
document.getElementsByTagName("head")[0].appendChild(b)
}},1000);
var ReCaptchaCallbackV3=function(){grecaptcha.ready(function(){var a=document.getElementsByClassName("grecaptcha-badge")[0];
if(a){let textareaElem=a.querySelectorAll("textarea")[0];
let labelElem=document.createElement("label");
labelElem.innerHTML="reCaptcha response";
labelElem.setAttribute("for",textareaElem.getAttribute("id"));
a.appendChild(labelElem);
